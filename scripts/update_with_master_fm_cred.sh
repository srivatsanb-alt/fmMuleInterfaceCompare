...
download_pull_fm_update $MASTER_FM_IP $MASTER_FM_PORT $HTTP_SCHEME $FM_VERSION $prod $registry_username $registry_password $static_file_auth_username $static_file_auth_password
